...
namespace RhythmGameStarter
{
    ...
    public class MidiTrackMappingEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.HelpBox("For differnt DAW, there might be different root octave, e.g. Ableton Live is 3, FL studio is 5, etc.. It depends on which tool you use to edit the midi clip.", MessageType.Info);
